  ...
  return (
    <div className="flex-1 overflow-y-auto p-6">
      ...
      <div className="flex items-start gap-4 overflow-x-auto">
        ...
        <div className="min-w-[760px] flex-1 overflow-hidden rounded-lg border border-border border-t-[3px] border-t-primary bg-card shadow-sm">
        <div className="flex items-center gap-2 px-4 py-3">
          <span className="h-2 w-2 shrink-0 rounded-full bg-primary" />
          <span className="flex-1 text-sm font-semibold">Data Grid</span>
          <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[11px] font-semibold text-primary">{totalRows || sortedRows.length} rows</span>
        </div>
        <div className="mx-2 rounded-md border border-dashed border-border px-3 py-2 text-xs text-muted-foreground">
        ...
        {showRightPanel && <aside className="w-[260px] shrink-0 space-y-3">
          <div className="overflow-hidden rounded-lg border border-border border-t-[3px] border-t-primary bg-card shadow-sm">
            <button
              type="button"
          ...
          <div className="overflow-hidden rounded-lg border border-border border-t-[3px] border-t-emerald-600 bg-card shadow-sm">
            ...
            >
              ...
              <span className="rounded-full bg-emerald-600/10 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">{approvalTotal} total</span>
          ...
          <div className="overflow-hidden rounded-lg border border-border border-t-[3px] border-t-emerald-600 bg-card shadow-sm">
            ...
            >
              ...
              <span className="rounded-full bg-emerald-600/10 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">{serverHealth?.completeness ?? healthMetrics.completeness}%</span>
